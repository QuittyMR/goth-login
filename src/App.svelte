<script lang="ts">
    ...
    import PasswordValidator from './lib/Passwordvalidator.svelte';
    import EmailValidator from './lib/EmailValidator.svelte';
    import Validated from 'lib/Validated.svelte';
        ...
        <div id="card">
            ...
            <div id="content" class="flex flex-col gap-y-10 w-max">
                ...
                <div id="inputs" class="space-y-4 block w-80 text-black">
                    <Validated let:validatorStates={validatorStates} validators={rules}>
